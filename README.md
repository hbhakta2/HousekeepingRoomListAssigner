...
- Before running this HousekeepingRoomListAssigner app
  ...
  - HousekeepingRoomListAssigner allows hotel operator to
      - create houseekeeping room list for housekeeping staff. User can add employee name, current date, mark room as stay over or checked out, and save list to text file.
